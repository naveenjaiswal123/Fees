...
public partial class FeesCollectionGridWiseAllMonth : System.Web.UI.Page
{
    ...
    public static string GetFeeDetails(string month_name, string class_name)
    {
        ...
        sql = " SELECT Fee.* , coll.TotalReceived FROM[SchoolDB].[dbo].[FeeStructure] Fee left join[dbo].[NurseryFeeCollection_2122] coll on Fee.Class=coll.Class and    Fee.MonthT=coll.[MonthT]   where  Fee.[Class]= '" + class_name + "' ";
        // sql = "SELECT * FROM TehsilMaster   ";
